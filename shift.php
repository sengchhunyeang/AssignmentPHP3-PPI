...
<head>
    ...
    <title>Student Shift (Static Form)</title>
...
<div class="page-wrapper">
    ...
    <div class="main-container">
        ...
        <div class="app-container" style="background-image: linear-gradient(#ffffff, #f0ca91); width:100%; height:953px;">
			...
			<?php include "./include/sidebarShift.php"; ?>

            <div class="row">
                <div class="col-sm-3">
                </div>
                <div class="col-sm-6 p-5">
                    <h3 class="text-center bg-danger p-3 rounded-4 text-white">បញ្ចូលម៉ោងសិក្សា (Static Form)</h3>
                    <form> <div class="mb-3 mt-3">
                            <label for="shift" class="form-label ">ម៉ោងសិក្សា :</label>
                            <input type="text" class="form-control" id="shift" placeholder="បញ្ចូលម៉ោងសិក្សា" disabled>
                        </div>
                        <div class="mb-3">
