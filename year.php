...
<head>
    ...
    <title>Student Year (Static Form)</title>
...
<div class="page-wrapper">
    ...
    <div class="main-container">
        ...
        <div class="app-container"
			...
			<?php include "./include/sidebarYear.php"; ?>

            <div class="row">
                <div class="col-sm-3">
                </div>
                <div class="col-sm-6 p-5">
                    <h3 class="text-center bg-danger p-3 rounded-4 text-white">បញ្ចូលឆ្នាំ (Static Form)</h3>
                    <form>
                        <div class="mb-3 mt-3">
                            <label for="year" class="form-label ">Year:</label>
                            <input type="text" class="form-control" id="year" placeholder="Enter Year" disabled>
                        </div>
                        <div class="mb-3">
