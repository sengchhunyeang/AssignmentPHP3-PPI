...
<head>
    ...
    <title>Student Group (Static Form)</title>
        ...
        <div class="app-container" style="background-image: linear-gradient(#ffffff, #f0ca91); width:100%; height:953px;">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 p-5">
                    <h3 class="text-center bg-danger p-3 rounded-4 text-white">បញ្ចូលក្រុមសិក្សា (Static Form)</h3>
                    <form> <div class="mb-3 mt-3">
                            <label for="group" class="form-label ">Group:</label>
                            <input type="text" class="form-control" id="group" placeholder="Enter Group" disabled>
                        </div>
                        <div class="mb-3">
