			...
			<div class="row justify-content-center">
				<div class="col-xl-4 col-lg-5 col-sm-6 col-12">
					<form action="index.html" class="my-5">
						<div class="border border-dark rounded-4 p-4 mt-5">
							<div class="login-form">
								...
								<div class="d-flex align-items-center justify-content-between">
									<div class="form-check m-0">
										...
										<label class="form-check-label" for="rememberPassword">ចងចាំពាក្យសម្ងាត់</label>
									</div>
									<a href="fogetpwd.php" class="text-blue text-decoration-underline">ភ្លេចពាក្យសម្ងាត់</a>
								</div>
